...
echo -n '$ '
typethis "# 让我们使用我们的流式API来看看谁向我发送了EOS代币......"
echo ""
echo -n '$ '
sleep 1
typethis 'MYTOKEN='$green' ...从 dfuse.io 领取你的代币... '$white
echo ""
echo -n '$ '
sleep .3
